                        ...
                        <div className="border-b border-black/10 dark:border-white/10 pb-6 mb-8">
                            <div className="flex items-center gap-3 mb-3">
                                <span className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-slate-900 dark:bg-white/10">
                                    <span className="material-symbols-outlined text-white dark:text-[#c4c7c8] text-lg"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#BBBBBB" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
                ...
                <motion.div variants={itemVariants} className="md:col-span-8 bg-white/80 dark:bg-[#201f22]/60 backdrop-blur-md border border-black/10 dark:border-white/5 p-[24px] rounded-xl hover:shadow-lg dark:hover:shadow-[0_0_20px_rgba(255,255,255,0.05)] hover:border-black/20 dark:hover:border-white/20 transition-all duration-300 group">
                    <div className="flex items-center justify-between border-b border-black/10 dark:border-white/10 pb-4 mb-6">
                        ...
                        <span className="material-symbols-outlined text-slate-400 dark:text-[#c4c7c8] group-hover:text-slate-800 dark:group-hover:text-[#ffffff] transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#BBBBBB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                            <circle cx="12" cy="12" r="3.5"></circle>
                            <path d="M 12 5 L 12 8.5"></path>
                            <rect x="10.5" y="2" width="3" height="3" rx="0.8"></rect>
                            <path d="M 12 19 L 12 15.5"></path>
                            <rect x="10.5" y="19" width="3" height="3" rx="0.8"></rect>
                            <path d="M 19 12 L 15.5 12"></path>
                            <rect x="19" y="10.5" width="3" height="3" rx="0.8"></rect>
                            <path d="M 5 12 L 8.5 12"></path>
                            <rect x="2" y="10.5" width="3" height="3" rx="0.8"></rect>
                            </svg>
                        </span>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-[16px]">
                        <div className="bg-slate-50/80 dark:bg-[#131315] p-5 border border-black/5 dark:border-white/5 rounded-lg hover:border-black/10 dark:hover:border-white/10 transition-colors duration-300 flex flex-col items-center text-center">
                            <span className="material-symbols-outlined text-4xl mb-3 text-slate-600 dark:text-[#9ca3af] group-hover:text-slate-900 dark:text-[#ffffff] transition-colors"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#BBBBBB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                <rect x="2" y="2" width="20" height="20" rx="3" ry="3"></rect>
                                <path d="M 2 8 h 20"></path>
                                <path d="M 12 8 v 14"></path>
                                </svg></span>
                        ...
                        <div className="bg-slate-50/80 dark:bg-[#131315] p-5 border border-black/5 dark:border-white/5 rounded-lg hover:border-black/10 dark:hover:border-white/10 transition-colors duration-300 flex flex-col items-center text-center">
                            <span className="material-symbols-outlined text-4xl mb-3 text-slate-600 dark:text-[#9ca3af] group-hover:text-slate-900 dark:text-[#ffffff] transition-colors"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#BBBBBB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                <rect x="4" y="4" width="6" height="6" rx="1" ry="1"></rect>
                                <rect x="14" y="4" width="6" height="6" rx="1" ry="1"></rect>
                                <rect x="4" y="14" width="6" height="6" rx="1" ry="1"></rect>
                                <rect x="14" y="14" width="6" height="6" rx="1" ry="1"></rect>
                                <path d="M 21 16 v 4"></path>
                                <path d="M 19 18 h 4"></path>
                                </svg></span>
                        ...
                        <div className="bg-slate-50/80 dark:bg-[#131315] p-5 border border-black/5 dark:border-white/5 rounded-lg hover:border-black/10 dark:hover:border-white/10 transition-colors duration-300 flex flex-col items-center text-center">
                            <span className="material-symbols-outlined text-4xl mb-3 text-slate-600 dark:text-[#9ca3af] group-hover:text-slate-900 dark:text-[#ffffff] transition-colors"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#BBBBBB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M 12 3 L 20 7 L 12 11 L 4 7 Z"></path>
                                <path d="M 4 13 L 12 17 L 20 13"></path>
                                </svg></span>
                ...
                <motion.div variants={itemVariants} className="md:col-span-12 mt-4 bg-white/80 dark:bg-[#201f22]/60 backdrop-blur-md border border-black/10 dark:border-white/5 rounded-xl p-6 md:p-8 hover:shadow-lg dark:hover:shadow-[0_0_20px_rgba(255,255,255,0.05)] hover:border-black/20 dark:hover:border-white/20 transition-all duration-300">
                    <div className="flex items-center justify-between mb-2 border-b border-black/10 dark:border-white/10 pb-4">
                        <div className="flex items-center gap-3">
                            <span className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-slate-900 dark:bg-white/10">
                                <span className="material-symbols-outlined text-white dark:text-[#c4c7c8] text-lg"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#BBBBBB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M 6 4 A 2 2 0 0 1 8 2 H 15 L 19 6 V 20 A 2 2 0 0 1 17 22 H 8 A 2 2 0 0 1 6 20 Z"></path>
                                    <path d="M 9 6 V 10"></path>
                                    <path d="M 12 6 V 10"></path>
                                    <path d="M 15 8 V 10"></path>
                                    <path d="M 6 14 H 19"></path>
                                </svg></span>
                            </span>
